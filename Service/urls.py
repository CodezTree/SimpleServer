...
urlpatterns = [
    ...
    path('articlecomp.action.now', views.articlecomp_action_now, name="artcomp_now"),
    path('articlecomp.action.keyword.confirm', views.articlecomp_action_keyword_send_app, name="artcomp_confirm"),
    path('articlecomp.action.keyword.confirm/', views.articlecomp_action_keyword_send_app, name="artcomp_confirm"),
    path('articlecomp.action.keyword.reject', views.articlecomp_action_keyword_reject, name="artcomp_reject"),
    path('articlecomp.action.keyword.reject/', views.articlecomp_action_keyword_reject, name="artcomp_reject"),
